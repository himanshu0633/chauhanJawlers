...
const DiamondSlider = () => {
    ...
    const slides = [
        {
            title: "The Rarity of Natural Diamonds",
            description: "Discover the extraordinary journey of diamonds, rare treasures formed deep within the Earth, shaped by nature's power, and cherished as symbols of love and eternity.",
            image: "https://staticimg.tanishq.co.in/microsite/diamond/images/naturalDiamond/diamond-rare.jpg"
        },
        {
            title: "Why Are Natural Diamonds Unique?",
            description: "Uncover the story of natural diamonds—each one a unique masterpiece shaped by Earth's history, crafted by Mother Nature, and as unique as the person wearing it.",
            image: "https://staticimg.tanishq.co.in/microsite/diamond/images/naturalDiamond/diamond-unique.jpg"
        },
        {
            title: "The Timeless Allure of Natural Diamonds",
            description: "Explore the timeless allure of diamonds—nature's enduring masterpiece, connecting us to Earth's ancient history and the love stories of generations.",
            image: "https://staticimg.tanishq.co.in/microsite/diamond/images/naturalDiamond/diamond-timeless.jpg"
        },
        {
            title: "What Makes Natural Diamonds so Valuable?",
            description: "Discover the multifaceted value of natural diamonds—from their enduring financial worth to their role as symbols of love, strength, and community impact.",
            image: "https://staticimg.tanishq.co.in/microsite/diamond/images/naturalDiamond/diamond-value.jpg"
        }
    ];
            ...
            <Box sx={{
                ...
                <Box sx={{
                    ...
                    <Box sx={{
                        ...
                        <Box sx={{
                            width: { xs: '10rem', md: '15rem' }, // Smaller circular image
